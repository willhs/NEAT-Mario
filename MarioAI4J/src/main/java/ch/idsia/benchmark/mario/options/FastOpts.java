...
public class FastOpts {
	...
	public static final String FLAT_FLY_SPIKEYS = L_FLAT + L_BLOCKS_OFF + L_CANNONS_OFF + L_COINS_OFF + L_DEAD_ENDS_OFF + L_GAPS_OFF + L_HIDDEN_BLOCKS_OFF
			+ L_PLATFORMS_OFF + L_LADDERS_OFF + L_TUBES_OFF + L_ENEMY(Enemy.SPIKY) + L_DIFFICULTY(0);

	public static final String FLAT_GOOMBAS = L_FLAT + L_BLOCKS_OFF + L_CANNONS_OFF + L_COINS_OFF + L_DEAD_ENDS_OFF + L_GAPS_OFF + L_HIDDEN_BLOCKS_OFF
			+ L_PLATFORMS_OFF + L_LADDERS_OFF + L_TUBES_OFF + L_ENEMY(Enemy.GOOMBA) + L_DIFFICULTY(0);

	public static final String FLAT_KOOPAS = L_FLAT + L_BLOCKS_OFF + L_CANNONS_OFF + L_COINS_OFF + L_DEAD_ENDS_OFF + L_GAPS_OFF + L_HIDDEN_BLOCKS_OFF
			+ L_PLATFORMS_OFF + L_LADDERS_OFF + L_TUBES_OFF + L_ENEMY(Enemy.SPIKY) + L_DIFFICULTY(0);

	public static final String FLAT_COINS = L_FLAT + L_BLOCKS_OFF + L_CANNONS_OFF + L_COINS_ON + L_DEAD_ENDS_OFF + L_GAPS_OFF + L_HIDDEN_BLOCKS_OFF
			+ L_PLATFORMS_OFF + L_LADDERS_OFF + L_TUBES_OFF + L_DIFFICULTY(0);

	public static final String COINS = L_BLOCKS_OFF + L_CANNONS_OFF + L_COINS_ON + L_DEAD_ENDS_OFF + L_GAPS_OFF + L_HIDDEN_BLOCKS_OFF
			+ L_PLATFORMS_OFF + L_LADDERS_OFF + L_TUBES_OFF + L_DIFFICULTY(0);

	public static final String FLAT_BRICKS = L_FLAT + L_BLOCKS_ON + L_CANNONS_OFF + L_COINS_ON + L_DEAD_ENDS_OFF + L_GAPS_OFF + L_HIDDEN_BLOCKS_OFF
			+ L_PLATFORMS_OFF + L_LADDERS_OFF + L_TUBES_OFF + L_DIFFICULTY(0);

	public static final String HILLY_BLANK = L_BLOCKS_OFF + L_CANNONS_OFF + L_COINS_OFF + L_DEAD_ENDS_OFF + L_GAPS_OFF + L_HIDDEN_BLOCKS_OFF
			+ L_PLATFORMS_OFF + L_LADDERS_OFF + L_TUBES_OFF;

	public static final String GOOMBAS_WINGED = L_BLOCKS_OFF + L_CANNONS_OFF + L_COINS_OFF + L_DEAD_ENDS_OFF + L_GAPS_OFF + L_HIDDEN_BLOCKS_OFF
			+ L_PLATFORMS_OFF + L_LADDERS_OFF + L_TUBES_OFF + L_ENEMY(Enemy.GOOMBA_WINGED);
}
