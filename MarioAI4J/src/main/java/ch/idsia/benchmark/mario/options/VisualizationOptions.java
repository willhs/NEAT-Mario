...
public class VisualizationOptions {
	...
	public static void reset() {
		...
		if (SimulatorOptions.receptiveFieldMode == null) SimulatorOptions.receptiveFieldMode = SimulatorOptions.ReceptiveFieldMode.NONE;
	}
	...
	public static SimulatorOptions.ReceptiveFieldMode getReceptiveFieldMode() {
		return SimulatorOptions.ReceptiveFieldMode.getForCode(MarioOptions.getInstance().getInt(IntOption.VISUALIZATION_RECEPTIVE_FIELD));
	}	
